      ...
      <div className="row">
        ...
        <div className={`${classes.SubOrganists} u-padding-bottom-medium`}>
          ...
          <div>
            <p>
              <strong>
                Those whose information states &quot;only
                Weddings/Funerals&quot; are not available on Sundays
              </strong>
            </p>
            ...
            <p>
              ...
              endorsement agency for service provided by the persons listed
              here. To learn proficiency of substitutes, feel free to ask them
              for references.
            </p>
          </div>
        </div>
